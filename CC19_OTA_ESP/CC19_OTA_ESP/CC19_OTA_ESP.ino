...
void setup() {
  ...
  Serial.println("Host: " + String(chipId, HEX));
...
void rainbow(int wait) {
  ...
  // means we'll make 65536/256 = 1280 passes through this outer loop:
  for(long firstPixelHue = 0; firstPixelHue < 65536; firstPixelHue += 256) {
    for(int i=0; i<strip.numPixels(); i++) { // For each pixel in strip...
      ...
      //do basic-software stuff (ESP8266) - normly its done at the end of each main-"loop"-cycle
      yield();
    }
